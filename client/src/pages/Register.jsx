...
const Register = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0e0e10] px-4 py-10 sm:px-6">
      <Link
        to="/"
        className="absolute left-4 top-4 z-20 rounded-lg border border-gray-700 bg-[#1a1f2b]/90 px-3 py-2 text-sm font-medium text-gray-200 transition-colors hover:border-amber-400/40 hover:text-amber-200 sm:left-6 sm:top-6"
      >
        Home
      </Link>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="rounded-2xl border border-gray-700/90 bg-[#181d28]/92 p-7 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-8">
          <h2 className="mb-1 text-center text-2xl font-semibold tracking-tight text-[#f4f4f5]">
            Create your account
          </h2>
          <p className="mb-6 text-center text-sm text-gray-400">
            Set up your secure environment vault
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-700 bg-[#151a24] py-3 pl-10 pr-4 text-sm text-gray-100 outline-none transition-all duration-200 placeholder:text-gray-500 focus:border-amber-400/80 focus:ring-2 focus:ring-amber-400/20"
              />
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[#181d28] px-2 text-xs tracking-[0.14em] text-gray-400">
                  OR CONTINUE WITH
                </span>
              </div>
            </div>
