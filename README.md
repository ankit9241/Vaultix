...
Vaultix is a personal developer vault that allows users to store environment variables, account credentials, and secure notes.
...
3. Check the `server/.env` file. It defaults to:
   ```env
   PORT=5000
   MONGODB_URI=mongodb://localhost:27017/vaultix
